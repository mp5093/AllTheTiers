...
data.techs.t_tiers_components2 = {
	...
	uplink_recipe = CreateUplinkRecipe({ special_circuit_board = 4, special_icchip = 2 }, 60),
	progress_count = 30,
...
data.techs.t_tiers_components3 = {
	...
	uplink_recipe = CreateUplinkRecipe({ special_icchip = 1, optic_cable = 2 }, 60),
	progress_count = 40,
...
data.techs.t_tiers_buildings3 = {
	...
	uplink_recipe = CreateUplinkRecipe({ special_circuit_board = 10, special_icchip = 2 }, 60),
	progress_count = 40,
...
data.techs.t_tiers_bots3 = {
	...
	uplink_recipe = CreateUplinkRecipe({ special_icchip = 2, engine = 2 }, 60),
	progress_count = 40,
...
data.techs.t_tiers_5 = {
	...
	uplink_recipe = CreateUplinkRecipe({ rainbow_research = 2 }, 30),
	progress_count = 200,
