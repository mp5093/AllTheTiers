...
data.items.rainbow_research.production_recipe = CreateProductionRecipe({ robot_research = 1, human_research = 1, blight_research = 1, virus_research = 1, special_icchip = 4 }, { c_data_analyzer = 600 })
